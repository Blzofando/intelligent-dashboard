...
const Dashboard: React.FC = () => {
  ...
  const {
    ...
    const completed = Array.from(completedLessons).filter((id) =>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="absolute bottom-0 left-0 -mb-10 -ml-10 w-64 h-64 bg-black/10 rounded-full blur-3xl animate-pulse"
            ...
            {nextLesson && (
              ...
              >
                ...
                <div className="relative flex flex-col items-start">
                  ...
                  <span className="text-sm leading-tight line-clamp-1 max-w-[200px]">
                    {nextLesson.title}
                  </span>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h2 className="text-lg font-semibold mb-2 text-gray-600 dark:text-gray-300 z-10">
              Progresso Geral
            </h2>
          ...
          >
            ...
            <p className="text-2xl md:text-4xl font-bold text-gray-800 dark:text-white mb-1">
          ...
          {totalTimeStudied > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 max-w-md">
                Comece a concluir algumas aulas para ver seu tempo de estudo
