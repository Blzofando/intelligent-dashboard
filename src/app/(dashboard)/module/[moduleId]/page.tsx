...
const ModuleDetail: React.FC = () => {
  ...
  if (!module) {
    return (
      <div className="text-center">
        ...
        <Link href="/course" className="text-primary-500 hover:underline mt-4 inline-block">Voltar para o curso</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <Link href="/course" className="text-primary-500 hover:underline">&larr; Voltar para os Módulos</Link>
